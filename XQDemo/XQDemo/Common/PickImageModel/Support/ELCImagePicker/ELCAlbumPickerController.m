        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = NSLocalizedString(@"没有对百爱妈妈开放权限访问相册", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"访问限制", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"确定", nil) otherButtonTitles:nil] show];
...
{
	[self.tableView reloadData];
	[self.navigationItem setTitle:NSLocalizedString(@"请选择相册", nil)];
}
